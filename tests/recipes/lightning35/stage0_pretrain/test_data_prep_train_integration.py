...
"""
Tests for data_prep.py → train.py integration in lightning35/stage0_pretrain.
...
class TestLightning35DataPrepTrainIntegration:
...
class TestWandbArtifactIntegration:
    """Test W&B artifact production and consumption for lightning35 pretrain."""
