...
- Use Curator image profiles for `byob/mcq`, `translate/curator`, and `curate/nemo_curator`; use the normal NeMo image with `data-designer==0.5.5` for `sdg/data_designer`.
