...
def sft(
    ...
    Examples:
        nemotron lightning35 model import sft /path/to/model --step 5000
        nemotron lightning35 model import sft /path/to/model --step 5000 --project my-project
    """
    ...
    # Create artifact
    artifact_name = name or "lightning35/sft/model"
