...
def pretrain(
    ...
    Examples:
        nemotron lightning35 model import pretrain /path/to/model --step 10000
        nemotron lightning35 model import pretrain /path/to/model --step 10000 --project my-project
    """
    ...
    # Create artifact
    artifact_name = name or "lightning35/pretrain/model"
