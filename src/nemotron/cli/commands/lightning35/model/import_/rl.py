...
def rl(
    ...
    Examples:
        nemotron lightning35 model import rl /path/to/model --step 2000
        nemotron lightning35 model import rl /path/to/model --step 2000 --project my-project
    """
    ...
    # Create artifact
    artifact_name = name or "lightning35/rl/model"
