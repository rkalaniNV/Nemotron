...
def rl(
    ...
    Examples:
        nemotron lightning35 data import rl /path/to/data_dir
        nemotron lightning35 data import rl /path/to/data_dir --project my-project
    """
    ...
    artifact_name = name or "lightning35/rl/data"
