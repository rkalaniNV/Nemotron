...
def sft(
    ...
    Examples:
        nemotron lightning35 data import sft /path/to/data_dir
        nemotron lightning35 data import sft /path/to/data_dir --project my-project
    """
    ...
    artifact_name = name or "lightning35/sft/data"
