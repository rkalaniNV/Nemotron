...
def pretrain(
    ...
    Examples:
        nemotron lightning35 data import pretrain /path/to/blend.json
        nemotron lightning35 data import pretrain /path/to/blend.json --project my-project
    """
    # Resolve data path
    ...
    artifact_name = name or "lightning35/pretrain/data"
