...
"""Data command group for lightning35."""

from __future__ import annotations

import typer

from nemotron.cli.commands.lightning35.data.import_ import import_app
from nemotron.cli.commands.lightning35.data.prep import prep_app
