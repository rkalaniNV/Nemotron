...
| [Translate Corpus](translate-corpus/README.md) | 10-row JSONL hello-world for the `src/nemotron/steps/translate/translation` step. Translates an OpenAI-style chat sample to Hindi, attaches FAITH scores, and previews the output. |
